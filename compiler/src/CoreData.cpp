...
{
    error(L"Force release %p (%i) references %i", i->first, i->second._type, i->second._references);
}
...
void CoreData::_print_depth(int i)
{
    for (int j = 0; j < i; j++)
        printf(" ");
}
